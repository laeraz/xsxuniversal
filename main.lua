...
function library:Introduction()
    ...
    xsxLogo.Size = UDim2.new(0, 170, 0, 170)
    xsxLogo.Visible = true
    xsxLogo.Image = "http://www.roblox.com/asset/?id=11433648214"
    ...
    hashLogo.Image = "http://www.roblox.com/asset/?id=17781182156"
    ...
    text.Position = UDim2.new(0.85, 0, 0, 0)
